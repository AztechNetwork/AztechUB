...
# ---- user ----
    ...
    # used for alive plugin (default: Aztech userbot logo image)
...
# --- bot ----
    ...
    BOT_NAME = os.getenv("BOT_NAME", "Aztech")
    # provide this if bot fails to get (optional)
...
# ---- assistant ----
    ...
    ASSISTANT_NAME = os.getenv("ASSISTANT_NAME", "Power")
    
    ASSISTANT_PIC = os.getenv("ASSISTANT_PIC", "./main/core/resources/images/Power.jpg")
...
# ---- other ----
    # your telegraph account name (default: Aztech userbot)
    TL_NAME = os.getenv("TL_NAME", "Aztech UserBot")
    # thumbnail used while uploading plugins, etc. (optional)
    THUMB_PIC = os.getenv("THUMB_PIC", "./main/core/resources/images/Aztech-square.jpg")
    # temporary download location (required)
    TEMP_DICT = os.getenv("TEMP_DICT", os.path.abspath(".") + "/downloads/")
    # official repo for updates
    UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/AztechNetwork/AztechUB.git")
