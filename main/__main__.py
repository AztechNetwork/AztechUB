...
async def send_logmessage():
    await app.bot.send_message(
        app.LOG_CHAT,
        "The Aztech UB is now alive.",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="Support Group",
                        url="t.me/AztechSupport"
                    )
                ]
            ]
        )
...
async def start_bot():
    ...
    print(20*"_" + ". Welcome to Aztech corporation ." + "_"*20 + "\n\n\n")
    ...
    print("You successfully deployed Aztech UserBot, try .ping or .alive commands to test it.")
