    ...
    if query.startswith("#pmpermit"):
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="Aztech Inline security system",
                description="Get Aztech security system inline menu.",
        ...
        results=[
            InlineQueryResultPhoto(
                ...
                title="Aztech Inline helpdex menu",
        ...
        results=[
            InlineQueryResultArticle(
                title="Aztech Inline anime quotes",
